...
describe('Notifications component tests', () => {
  ...
  it('should render li', () => {
    const childWrapper = wrapper.find(NotificationItem);
    expect(childWrapper.first().html()).toEqual(`<li data-notification-type="default" class="default_1tsdo2i">New course available</li>`)
  })

  it('menu item is being displayed when displayDrawer is false', () => {
    const wrapper = shallow(<Notifications displayDrawer={true || false} />);
    expect(wrapper.find('.menuItem_140n9qh').exists()).toBe(true);
  })
