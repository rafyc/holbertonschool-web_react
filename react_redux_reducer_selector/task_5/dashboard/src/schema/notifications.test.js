...
describe('Notifications data tests', () => {
    it('test reading data from a JSON', () => {
        const data = [
            {
        ...
        expect(context.length).toEqual(2);
    });

    it('test normalized data has correct result array', () => {
        const data = [
    ...
    it('test normalized data has correct message entity', () => {
        const data = {
    ...
    it('test normalized data has correct notification entity', () => {
        const data = {
